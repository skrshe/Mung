...
winscreen :: proc "c" () {
    ...
    if whowon() == "p2" {
        ...
        w4.blit(&tex.heart[0],99,82,8,8)
    } else {
        w4.text( "We're all",  43, 65)
        w4.text("Winners!!!", 40, 75)
    }

    w4.blit(&tex.heart[0],20,20,8,8)
	w4.DRAW_COLORS^ = 2
    w4.blit(&tex.heart[0],20,140,8,8)
	w4.DRAW_COLORS^ = 4
    w4.blit(&tex.heart[0],140,20,8,8)
    w4.blit(&tex.smiley[0],140,140,8,8)
}
